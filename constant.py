...
#hrcosine_distn_file= "z_=0.0000_sat_info.dat"
hrcosine_distn_file_roche = "high_res_cosine_distn_file_roche_slice.dat"
#control sample

###isolated halo file
isolated_lg_file_nosub = "hr_isolated_lg_halo_nosub.dat" #produced from overlapping.py
isolated_lg_file_at_a_Dsep = "hr_isolated_at_a_Dsep.dat" #produced from overlapping.py
...
folder_control = "smallhalos_highres_iso"
folder_control_not_rotated = "smallhalos_highres_iso_not_rotated"
...
OMmassmin = LGmassmax_z0
SMALLmassmax = LGmassmin_z0

mass_limit_dat_merger = "maxmin_hostmass_merger.dat" # mass limits obtained from the max progenitor of the z=0 hosts from merger tree
z_redshift, massmax_lis0, massmin_lis0 = loadtxt(mass_limit_dat_merger, unpack =1)
